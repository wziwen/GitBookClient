...
public class TaskItemAdapter extends RecyclerView.Adapter<TaskItemAdapter.TaskItemViewHolder> {
    ...
    private View.OnClickListener taskActionOnClickListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            TaskItemAdapter.TaskItemViewHolder holder = (TaskItemAdapter.TaskItemViewHolder) v.getTag();
            ...
            if (action.equals(v.getResources().getString(R.string.pause))) {
                ...
                EpubReaderActivity.start(v.getContext(), model.getPath(), model.getName());
            }
            // to delete
...
//                holder.updateNotDownloaded(FileDownloadStatus.INVALID_STATUS, 0, 0);
    ...
    public TaskItemAdapter.TaskItemViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        TaskItemAdapter.TaskItemViewHolder holder = new TaskItemAdapter.TaskItemViewHolder(
                LayoutInflater.from(
                        parent.getContext())
    ...
    @Override
    public void onBindViewHolder(TaskItemAdapter.TaskItemViewHolder holder, int position) {
        ...
        public void updateDownloading(final int status, final long sofar, final long total) {
            ...
            switch (status) {
                ...
                case FileDownloadStatus.progress:
                    ...
                    break;
                default:
                    taskStatusTv.setText(taskStatusTv.getContext().getString(
